...
<div class="wrap">
    ...
    if (!Yii::$app->user->isGuest) {
        ...
        $menuItems[] = [
            ...
            'items' => [
                ['label' => '<span class="glyphicon glyphicon-user"></span> Usuários'],
                ['label' => '&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-plus"></span> Adicionar Usuários', 'url' => ['user/create'],],
                ['label' => '&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-list"></span> Listar Usuários', 'url' => ['user/index'],],
